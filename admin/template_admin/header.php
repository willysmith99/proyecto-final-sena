...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="nav navbar-nav">
            <a class="nav-item nav-link" href="menu_admin.php">Inicio</a>
            <a class="nav-item nav-link" href="registro_donacion.php">Reportes de donación</a>
            <a class="nav-item nav-link" href="registro_adopcion.php">Reportes de adopción</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="gestion_admin.php?id=<?php echo $_SESSION['id'] ;?>">Gestionar Cuenta</a>
                    <a class="dropdown-item" href="registro_admin.php">Registrar Admin</a>
