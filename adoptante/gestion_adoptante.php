...
<?php
    ...
    if (isset($_POST['actualizar'])) {
        ...
        header("Location:menu_adoptante.php");
...
<form class="p-3 contenedor bg-primary bg-opacity-25" method="POST">
            ...
            <div class="col-md-12">
                <div class="form-group row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" value="<?php echo $row['nombre'];; ?>" class="form-control" id="nombre" name="nombre"
                            placeholder="Ingresa tu nombre" >
                    </div>
                    <div class="col-md-6">
                        <label for="apellido" class="form-label">Apellido<span class="text-danger">*</span></label>
                        <input type="text" value="<?php echo $row['apellido']; ?>" class="form-control" id="apellido" name="apellido"
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-6">
                        <label for="documento" class="form-label">N° de documento<span
                                class="text-danger">*</span></label>
                        <input type="text" value="<?php echo $row['documento']; ?>" class="form-control" name="documento"
                ...
                <div class="form-group row mb-3 ">
                    <div class="col-md-6">
                        <label for="telefono" class="form-label">N° de teléfono <span
                                class="text-danger">*</span></label>
                        <input type="tel" value="<?php echo $row['telefono']; ?>" class="form-control" id="telefono" name="telefono"
                            placeholder="Ingresa tu N° de teléfono" >
                    </div>
                    <div class="col-md-6">
                        <label for="correo" class="form-label">Correo <span class="text-danger">*</span></label>
                        <input type="email" value="<?php echo $row['correo']; ?>" class="form-control" id="correo" name="correo"
    ...
    <div class="d-flex justify-content-center">
         ...
         <button type="button" class="btn btn-primary w-25 me-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
                Actualizar
            </button>
        ...
        <!-- <button type="submit" name="actualizar" class="btn btn-primary w-25 me-3">Actualizar</button> -->
        &nbsp;
        <button type="submit" name="cancelar" class="btn btn-danger w-25 ms-3">Cancelar</button>
    </div>   
