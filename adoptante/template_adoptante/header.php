...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="nav navbar-nav">
            <a class="nav-item nav-link" href="menu_adoptante.php">Inicio</a>
            <a class="nav-item nav-link" href="ver_mascota.php">Ver mascotas</a>
            <a class="nav-item nav-link" href="ver_registro.php">Solicitudes</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="gestion_adoptante.php?id=<?php echo $_SESSION['id'] ;?>">Gestionar Cuenta</a>
